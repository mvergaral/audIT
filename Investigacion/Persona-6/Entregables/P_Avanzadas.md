...
3. La técnica criptográfica que permite satisfacer el derecho de supresión de un conductor (Art. 8 ter de la Ley 21.719) sin corromper la integridad referencial de las bases de datos de despachos ni infringir los plazos de retención tributaria de 6 años se denomina ________ (o su término en inglés).
