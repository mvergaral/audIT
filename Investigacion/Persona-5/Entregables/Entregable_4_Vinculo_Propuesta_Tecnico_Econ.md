...
| **EDT 3.4** | **Conectores de Ingesta Telemática Segura** | Bases Técnicas Transversales, RT-11.10 y RT-05.20 | Implementación del cifrado a nivel de campo (FLE AES-256-GCM) en PostgreSQL 16 con Azure Key Vault Managed HSM; Capa Anticorrupción frente al ERP 2013. |
