...
**Marco Normativo:** Bases Administrativas FEP01.26 (Art. 13.5 y Formulario A-6), Comunicado 9 y Pauta de División de Roles.
...
2. **Alcance de la Asistencia de IA (Nivel 1 - Asistencia Estilística y Formato):**
   ...
   * Ningún párrafo de análisis, justificación económica ni cálculo cuantitativo fue delegado a la generación autónoma de IA.
...
```
┌────────────────────────────────────────────────────────────────────────────────────────┐
│ REGISTRO DE INTERACCIONES DE APOYO FORMULARIO A-6 — CARLOS ABARZA (PERSONA 4)          │
├────┬────────────┬──────────────────────────────────────────┬──────────────┬────────────┤
│ ID │ Fecha/Hora │ Tarea de Apoyo Solicitada                │ Nivel de Uso │ Finalidad  │
├────┼────────────┼──────────────────────────────────────────┼──────────────┼────────────┤
│ 01 │ 16-09 13:10│ Formateo de tabla de paridades E-24      │ Nivel 1      │ Diagramación│
│ 02 │ 16-09 14:15│ Tabulación Markdown de Matriz Legal (13) │ Nivel 1      │ Maquetación │
...
### Registro A6-01: Formateo de Tabla de Paridades Económicas E-24
* **Fecha y Hora:** 16-09-2026 13:10 hrs.
* **Integrante:** Carlos Abarza (Persona 4).
* **Sección del Informe:** 5.1 Enfoque Metodológico e Integración Económica.
...
### Registro A6-02: Tabulación Markdown de Matriz de Obligaciones (13 Partidas)
* **Fecha y Hora:** 16-09-2026 14:15 hrs.
* **Integrante:** Carlos Abarza (Persona 4).
* **Sección del Informe:** 5.2 Matriz de Obligaciones Normativas y Costeo Directo.
* **Herramienta y Versión:** Asistente IA (Motor Claude / Gemini 3.8).
* **Nivel de Uso:** Nivel 1 (Maquetación y alineación de datos).
* **Prompt Empleado:**
  > *"Tengo el borrador de las 13 obligaciones legales del Caso 10 con sus artículos (Ley 21.719, Ley 21.663, ISO 27001), actividades, roles E-26, plazos y montos en UF que calculé. Dale formato de tabla Markdown estricta con las 5 columnas requeridas: Obligación Normativa, Actividad Clave, Rol Responsable, Plazo / Hito y Costo Estimado Directo (UF)."*
* **Uso del Resultado:** Se utilizó la tabla estructurada para ordenar visualmente el levantamiento normativo.
* **Verificación Humana:** Revisión manual de que cada fila preservara los artículos legales y los valores en UF calculados por el alumno.

---

### Registro A6-03: Revisión Ortográfica y Estilo Técnico
* **Fecha y Hora:** 16-09-2026 16:30 hrs.
* **Integrante:** Carlos Abarza (Persona 4).
* **Sección del Informe:** 5.1 y 5.2 (Redacción general).
* **Herramienta y Versión:** Asistente IA (Motor Claude / Gemini 3.8).
* **Nivel de Uso:** Nivel 1 (Corrección gramatical y de estilo).
* **Prompt Empleado:**
  > *"Revisa la ortografía, puntuación y concordancia técnica del siguiente párrafo introductorio sobre la metodología de costeo TCO bajo la Ley 21.719, asegurando un tono formal y académico sin alterar los conceptos ni los nombres de los cargos."*
* **Uso del Resultado:** Se aplicaron las correcciones de puntuación sugeridas en el borrador del informe.
* **Verificación Humana:** El estudiante leyó y validó que el texto preservara el sentido conceptual original.

---

### Registro A6-04: Traducción Técnica de Documentación de Proveedores Cloud
* **Fecha y Hora:** 17-09-2026 11:20 hrs.
* **Integrante:** Carlos Abarza (Persona 4).
* **Sección del Informe:** 5.4 Precios de Mercado e Insumos Externos.
* **Herramienta y Versión:** Asistente IA (Motor Claude / Gemini 3.8).
* **Nivel de Uso:** Nivel 1 (Traducción técnica).
* **Prompt Empleado:**
  > *"Traduce al español técnico los siguientes términos de la ficha de precios de Microsoft Azure: 'Azure Key Vault Managed HSM B-series cryptographic operations', 'multi-region replication latency SLA' y 'advanced key rotation policy'."*
* **Uso del Resultado:** Permitió consignar con precisión la terminología técnica en castellano para la glosa de insumos de hardware de seguridad.
* **Verificación Humana:** Se cotejó la traducción con la documentación en español de Microsoft Azure Learn.

---

### Registro A6-05: Depuración de Sintaxis KaTeX en Ecuaciones Financieras
* **Fecha y Hora:** 17-09-2026 15:45 hrs.
* **Integrante:** Carlos Abarza (Persona 4).
* **Sección del Informe:** 5.3 y 5.5 (Ecuaciones de VAN, RoSI y Gordon-Loeb).
* **Herramienta y Versión:** Asistente IA (Motor Claude / Gemini 3.8).
...
### Registro A6-08: Maquetación y Control de Longitud en Plantilla LaTeX
* **Fecha y Hora:** 19-09-2026 18:20 hrs.
* **Integrante:** Carlos Abarza (Persona 4).
* **Sección del Informe:** Ensamblaje final de subdocumento.
* **Herramienta y Versión:** Asistente IA (Motor Claude / Gemini 3.8).
* **Nivel de Uso:** Nivel 1 (Ajuste de código de diagramación LaTeX).
* **Prompt Empleado:**
  > *"Ayúdame a ajustar el espaciado vertical \vspace y el tamaño de fuentes de las tablas en este código LaTeX para que el subdocumento de 5 secciones quepa exactamente en el límite editorial estricto de 2 páginas sin cortar texto."*
* **Uso del Resultado:** Se optimizaron los comandos de espaciado para lograr una maquetación compacta y profesional a 2 páginas.
* **Verificación Humana:** El estudiante compiló el archivo PDF resultante y verificó que tuviera exactamente 2 páginas completas y legibles.

---

## 4. Firma y Compromiso de Responsabilidad
