...
\figuraAncha{assets/images/Persistencia.pdf}{Persistencia políglota. Consistencia estricta, disponibilidad extrema y capa transitoria}{persistencia}
...
\figuraAncha{assets/images/Costo.pdf}{Construcción del costo real por kilómetro con fuentes de distinto desfase}{costo}
