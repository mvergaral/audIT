...
\begin{tablaAudit}{Rasgos del sistema de 2013 y respuesta de esta arquitectura}{heredado}{@{}p{3.4cm}p{5.7cm}p{5.9cm}@{}}
\textbf{Rasgo} & \textbf{Efecto que produce hoy} & \textbf{Respuesta de esta arquitectura} \\ \midrule
...
\begin{tablaAudit}{Componentes declarados por capa}{componentes-capa}{p{3.2cm}p{10.8cm}}
\textbf{Capa} & \textbf{Componentes} \\ \midrule
...
\figuraAncha{assets/images/LogicaCapas.pdf}{Las ocho capas obligatorias del numeral 2.1 transversal, con sus componentes e interfaces, conforme a RT-02.01}{capasfig}
...
\begin{tablaAudit}{Decisiones de arquitectura lógica registradas}{adr}{@{}p{0.8cm}p{3.6cm}p{3.3cm}p{3.0cm}p{3.3cm}@{}}
\textbf{ADR} & \textbf{Contexto} & \textbf{Decisión} & \textbf{Alternativa descartada} & \textbf{Criterio} \\ \midrule
...
\subsubsection{Degradación, escalamiento y puntos únicos de falla}
...
y los límites se declaran en esta sección. El costo asociado se remite al Sobre N.\textordmasculine{}
...
\begin{tablaAudit}{Puntos únicos de falla declarados}{spof}{@{}p{4.4cm}p{5.0cm}p{5.6cm}@{}}
\textbf{Punto} & \textbf{Por qué subsiste} & \textbf{Por qué es aceptable} \\ \midrule
...
\begin{tablaAudit}{Parámetros de los patrones de resiliencia}{resparam}{p{3.6cm}p{10.4cm}}
\textbf{Patrón} & \textbf{Parámetro declarado} \\ \midrule
...
\begin{tablaAudit}{Reparto del presupuesto de 30 segundos}{presupuesto}{p{6.6cm}p{3.2cm}p{4.2cm}}
\textbf{Paso} & \textbf{Presupuesto} & \textbf{Dónde se resuelve} \\ \midrule
...
\begin{tablaAudit}{Contenido del documento de error ante un despacho rechazado}{error}{p{3.2cm}p{10.8cm}}
...
\subsubsection{Gobernanza de interfaces y contratos}
...
\begin{tablaAudit}{Declaración por integración conforme a RT-05.21}{integraciones}{@{}p{3.3cm}p{1.9cm}p{3.5cm}p{2.5cm}p{3.2cm}@{}}
\textbf{Contraparte} & \textbf{Modo} & \textbf{Volumen esperado} & \textbf{Ventana de la contraparte} & \textbf{Si no responde} \\ \midrule
...
\begin{tablaAudit}{Piezas de la capa anticorrupción}{acl}{p{4.2cm}p{9.8cm}}
\textbf{Pieza} & \textbf{Función} \\ \midrule
...
\paragraph{Emisión del documento de transporte sin cobertura.} La decisión 9 del numeral 16.1 y
...
\figuraAncha{assets/images/D3-diagrama12_integracion_acl_erp2013.png}{Integración con el sistema contable heredado a través de la capa anticorrupción}{acl}
...
\begin{tablaAudit}{Parámetros leídos de la telemetría de fábrica}{fms}{p{5.4cm}p{8.6cm}}
\textbf{Parámetro} & \textbf{Para qué se usa} \\ \midrule
...
\begin{tablaAudit}{Capas del repositorio analítico}{medallion}{p{2.6cm}p{5.6cm}p{5.8cm}}
\textbf{Capa} & \textbf{Qué contiene} & \textbf{Qué garantiza} \\ \midrule
...
\figuraAncha{assets/images/D3-diagrama13_arquitectura_analitica_lakehouse_bi.png}{Capa analítica por niveles de refinamiento y explotación del costo por kilómetro}{lakehouse}
...
\begin{tablaAudit}{Componentes del costo por viaje y su origen}{costo}{p{3.6cm}p{4.4cm}p{6cm}}
\textbf{Componente} & \textbf{Flota propia} & \textbf{Flota subcontratada} \\ \midrule
...
\begin{tablaAudit}{Latencias de la capa analítica fijadas por RT-05.29 del Caso}{latencias}{p{7cm}p{7cm}}
\textbf{Dato} & \textbf{Latencia máxima} \\ \midrule
...
\subsubsection{Explotación analítica y autoservicio}
...
\figuraAncha{assets/images/D3-diagrama2_arquitectura_tactica_ddd.png}{Modelo táctico del dominio. Agregados, entidades y servicios por contexto}{ddd}
...
\begin{tablaAudit}{Inventario de componentes lógicos}{inventario}{@{}p{4.2cm}p{2.0cm}p{1.6cm}p{2.2cm}p{4.3cm}@{}}
\textbf{Componente} & \textbf{Capa} & \textbf{Latencia} & \textbf{Criticidad} & \textbf{Volumen} \\ \midrule
...
\subsubsection{Concurrencia y volumen declarados}
...
\begin{tablaAudit}{Concurrencia derivada de la volumetría del Caso}{concurrencia}{@{}p{6.6cm}p{2.6cm}p{5.8cm}@{}}
\textbf{Población} & \textbf{En hora punta} & \textbf{Base de la derivación} \\ \midrule
...
\begin{tablaAudit}{Volumen anual de telemetría derivado}{telemetria}{p{6.4cm}p{3.2cm}p{4.4cm}}
\textbf{Magnitud} & \textbf{Valor} & \textbf{Derivación} \\ \midrule
...
\figuraAncha{assets/images/D3-diagrama11_patrones_resiliencia_despacho.png}{Patrones de resiliencia y flujo de la asignación bloqueante}{resiliencia}
...
\begin{enumerate}
    ...
    \item \textbf{Las consultas del Artículo 43 están enviadas y no respondidas.} Las
...
\figuraAncha{assets/images/Contextos.pdf}{Contextos delimitados del dominio y sistemas con los que convive la solución}{contextos}

\figuraAncha{assets/images/LogicaIntegraciones.pdf}{Mapa de integraciones. Sistemas internos, fuentes de terreno y contrapartes externas}{integraciones}

\figuraAncha{assets/images/Main.pdf}{Arquitectura física general. Nube, sitio de continuidad, gabinetes de terminal y flota}{fisica}

\figuraAncha{assets/images/Camion.pdf}{El camión como componente on-premise distribuido}{camion}

\figuraAncha{assets/images/DosEjes.pdf}{Separación entre recuperación ante desastres y continuidad operacional en el borde}{dosejes}

\figuraAncha{assets/images/Flujo.pdf}{Flujo de un evento de jornada registrado sin cobertura}{flujo}

\figuraAncha{assets/images/LogicaEmplazamiento.pdf}{Correspondencia entre capa lógica y emplazamiento físico}{emplazamiento}
...
3 & Despacho y asignación & $\leq$ 30 s extremo a extremo & Máxima & 96.000 viajes/año & Sin exigencia específica & Requiere enlace & Elástico \\
4 & Nodo de continuidad & $\leq$ 30 s local & Máxima & Ventana de 12 h & Sin exigencia específica & Opera sin enlace & Fijo, dos nodos \\
6 & Servicio de jornada & $\leq$ 30 s & Máxima & 454 conductores & Datos personales de 258 externos & Requiere enlace & Elástico \\
9 & Bus de telemetría & $\leq$ 100 ms & Crítica & Peak de reconexión masiva & Sin exigencia específica & Requiere enlace & Elástico por partición \\
14 & Base transaccional & $\leq$ 15 ms & Máxima & Particionado mensual & Retención 5-10 años & Requiere enlace & Reservado \\
15 & Series de tiempo & $\leq$ 20 ms & Alta & 2 años en línea + agregación & Sin exigencia específica & Requiere enlace & Por capa hot/cold \\
17 & Repositorio inmutable & $\leq$ 1 s & Alta & Evidencia probatoria & WORM, 10 años siniestros & Requiere enlace & Por capa de acceso \\
21 & Identidad y cifrado & $\leq$ 50 ms & Crítica & Sin exigencia específica & RT-11.10 cifrado a nivel de campo . Ley 21.719 & Requiere enlace & Fijo por HSM \\
23 & Réplica de DR & RPO $\leq$ 15 min & Crítica & Espejo de producción & Sin exigencia específica & Enlace entre regiones & Activo-pasivo \\
...
33 & Módulo satelital & $\leq$ decenas de s & Alta & Ráfagas cortas & Sin exigencia específica & Sin cobertura celular & Por mensaje \\
