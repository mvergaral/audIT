...
- **Condicionado:** depende de una validación externa todavía abierta, sea jurídica, de
  interfaz o del CLIENTE. El requisito se compromete; su viabilidad se confirma.
...
- La exigencia normativa reside en la fuente. Los mecanismos, las etapas y las metas son
  la propuesta del PROPONENTE. Ningún estado de esta tabla acredita cumplimiento
  demostrado, que se verifica durante la ejecución.
...
| RF-007 | Descargar la información disponible de tacógrafos, asociarla con conductor y vehículo, conservar el original y permitir su consulta. Periodicidad según CA-07. | CA-07; R-02; R-03; D-13 | Must | E1 | Piloto por modelo y prueba de contingencia física. | Condicionado |
...
| RF-011 | Generar evidencia consultable de tiempos de espera y relacionarla con viaje, reglas contractuales y cobro de sobreestadía. Reducción de objeciones según CA-11. | CA-11; D-08 | Must | E1 | Muestreo de cobros y medición de tasa de objeción. | Condicionado |
...
| RF-015 | Recomendar retornos considerando ubicación, jornada, habilitaciones, compatibilidad, plazo y aceptación del transportista, y medir kilómetros vacíos. Reducción de kilómetros vacíos según CA-15. | CA-15; R-02; D-14 | Should | E2 | Piloto antes/después y registro de recomendaciones. | Condicionado |
...
| RF-018 | Relacionar kilometraje, consumo, ruta, vehículo, conductor y condiciones para explicar la dispersión de rendimiento entre camiones comparables. Meta analítica según CA-18. | CA-18; D-12; D-15 | Should | E2 | Análisis reproducible sobre muestra comparable. | Condicionado |
...
| RF-026 | Administrar adhesión de los 148 transportistas, registrando invitación, condiciones, consentimiento, estado, fecha, equipos y capacidades habilitadas. Metas y plazo según CA-27. | CA-27; R-02; R-03; D-02; D-05 | Must | E1 | Reporte periódico y muestreo contractual. | Condicionado |
| RF-027 | Calcular a bordo una alerta anticipada según jornada restante, ubicación, ruta y tiempo hasta un lugar seguro. Margen mínimo de anticipación según CA-28. | CA-28; R-01; R-04; D-07 | Must | E1 | Prueba en rutas piloto, incluido caso sin lugar alcanzable. | Condicionado |
...
| RNF-004 | Toda intervención física a bordo ocurrirá durante el paso normal por terminal, sin inmovilización adicional no declarada. Duración y cobertura de despliegue según CA-08. | R-05; R-10; R-11; D-25 | Must | E1 | Pilotos cronometrados por familia. | Condicionado |
...
9. Resuelto. Son 3 contratos servidos bajo costo, equivalentes al 31 % del ingreso, y 2 de ellos se renegocian en 2027 (FEP03 · Sección 7.3 · p.15 y Sección 13.2 · p.27).
