...
4. **Propiedad del dispositivo:** el CLIENTE adquiere el hardware conforme al Capítulo 11.
   Falta costear y formalizar el comodato hacia el transportista adherido y los servicios
   de instalación, soporte y retiro que presta AUDIT.
...
| 5 | Ratificada D2 | El CLIENTE adquiere todo el hardware conforme a FEP03 · Capítulo 11 · p.24, y AUDIT especifica qué comprar, cuánto y con qué características. El equipo instalado en un camión de tercero se entrega en comodato al transportista adherido, con AUDIT a cargo de configuración, instalación, soporte y retiro como parte del servicio. En camiones de terceros se exige adhesión y autorización expresa. | Costear instalación, conectividad, suscripciones, mantención, repuestos y retiro dentro del servicio; regular equipos preexistentes, responsabilidad por daño y término de la relación. | Matías lidera; D1 y D4 |
