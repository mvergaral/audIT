...
**Estado:** metas ratificadas por D2 el 06-09-2026, comprometidas para el Informe 1
...
| 09 | Los tramos sin señal dejan vacíos. | **Obligatorio:** al menos 72 h, cero registros perdidos; E1. Sincronización en hasta 20 minutos por camión tras la reconexión, conforme a RT-03.13. | Ensayo offline, conteo/hash y reconexión simultánea. | RF-009, RNF-002 |
| 10 | Llegadas/salidas anotadas en papel y de memoria. | Registro automático sin acción del conductor ni equipos en el cliente, contrastando los cruces con agenda, EDI, API u otra evidencia disponible; **Obligatorio**. Radio de geocerca y precisión aceptable: **parámetro a fijar en la Etapa 1**, con la campaña de cobertura y el piloto en terreno; E1. | Piloto, evidencia independiente y falsos cruces. | RF-010, RNF-001, RNF-007 |
...
| 12 | Evidencia viaja en papel; 4,2 % no llega. | Firma y código OTP del receptor identificado, con sello temporal, ubicación y evidencia adjunta; disponible el mismo día, cero conformidades perdidas y ≥99 % antes del cierre diario; **meta del PROPONENTE**; E1. | Tiempos de entrega, captura y publicación. | RF-012, RNF-007 |
