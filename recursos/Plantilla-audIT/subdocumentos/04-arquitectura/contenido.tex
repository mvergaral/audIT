...
\figuraHorizontal{LogicaCapas.pdf}{Las ocho capas obligatorias del numeral 2.1 transversal, con sus componentes e interfaces, conforme a RT-02.01}{capasfig}
...
\begin{tablaAudit}{Tecnologías de software, versiones y soporte ofertado}{software}{@{}p{3.2cm}p{3.0cm}p{2.6cm}p{5.0cm}@{}}
\textbf{Componente} & \textbf{Producto y versión} & \textbf{Fin de soporte} & \textbf{Plan a 56 meses y justificación} \\ \midrule
...
\figuraHorizontal{Contextos.pdf}{Contextos delimitados del dominio y sistemas con los que convive la solución}{contextos}

\figuraHorizontal{LogicaIntegraciones.pdf}{Mapa de integraciones. Sistemas internos, fuentes de terreno y contrapartes externas}{integraciones}

\figuraHorizontal{Main.pdf}{Arquitectura física general. Nube, sitio de continuidad, gabinetes de terminal y flota}{fisica}

\figuraHorizontal{Camion.pdf}{El camión como componente on-premise distribuido}{camion}

\figuraHorizontal{DosEjes.pdf}{Separación entre recuperación ante desastres y continuidad operacional en el borde}{dosejes}

\figuraHorizontal{Flujo.pdf}{Flujo de un evento de jornada registrado sin cobertura}{flujo}

\figuraHorizontal{LogicaEmplazamiento.pdf}{Correspondencia entre capa lógica y emplazamiento físico}{emplazamiento}
