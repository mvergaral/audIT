...
\textbf{Resultado esperado.} Reducción del tiempo de cierre mensual y del porcentaje de
...
\textbf{Lo que agrega sobre lo que las bases ya exigen.} Los criterios 21 y 29 obligan a que el
...
\textbf{Madurez.} Escala de niveles de madurez tecnológica de uno a nueve
...
\textbf{Incorporación en la arquitectura y en el cronograma.} Un servicio de emisión de expediente
...
\textbf{Impacto económico.} La inversión es incremental sobre el portal, que ya está presupuestado
...
\textbf{Indicador de verificación.} Línea base cero, porque la capacidad no existe. Meta de
...
\textbf{Riesgo de adopción.} El riesgo principal es que el transportista no perciba utilidad y no
...
\textbf{Idea.} Un camión detenido no produce, la intervención a bordo solo puede hacerse cuando el
...
\textbf{Tecnología que la sustenta.} Anticipación de la llegada al terminal a partir de la posición
...
\textbf{Resultado esperado.} Unidades intervenidas por mes y tiempo de inmovilización por unidad.
...
\textbf{Investigación adicional requerida.} Ninguna en el concepto. El tiempo real de intervención
...
\textbf{Tecnología que la sustenta.} Almacenamiento local estructurado y cifrado a bordo con
...
\textbf{Resultado esperado.} Los indicadores parten de una línea base medida.
...
\textbf{Investigación adicional requerida.} La factibilidad de exportación de la plataforma que hoy
...
\textbf{Lo que agrega sobre lo que las bases ya exigen.} El Capítulo 11 resuelve quién compra el
...
\textbf{Incorporación en la arquitectura y en el cronograma.} La ventana se aplica en la unidad
...
\textbf{Indicador de verificación.} Línea base cero de ciento cuarenta y ocho transportistas
...
\subsection{Tipo 5. Alerta de jornada con lugar seguro alcanzable}

\textbf{Idea.} Una alerta que avisa al conductor que su jornada se agota, entregada en un tramo
...
\textbf{Tecnología que la sustenta.} Cálculo del margen restante a bordo del vehículo, sin depender
...
\textbf{Resultado esperado.} Porcentaje de alertas entregadas con anticipación suficiente para
...
\textbf{Investigación adicional requerida.} El catálogo de lugares seguros de detención no existe
