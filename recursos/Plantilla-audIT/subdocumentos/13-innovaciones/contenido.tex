...
\textbf{Investigación adicional requerida.} Ninguna. La capacidad depende del motor de costeo que
...
\textbf{Resultado esperado.} Número de transportistas adheridos sobre el total de 148 y plazo en
...
\textbf{Investigación adicional requerida.} El modelo de financiamiento del equipamiento y el
