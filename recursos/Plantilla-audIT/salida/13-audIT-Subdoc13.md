...
**Alcance y delimitación frente a las bases.** Los criterios 21 y 29 obligan a que el
...
**Forma de implementación y cronograma.** Un servicio de emisión de expediente
...
**Resultados esperados e indicadores.** Reducción del tiempo de cierre mensual y del porcentaje de
...
**Madurez e impacto.** Escala de niveles de madurez tecnológica de uno a nueve
...
**Riesgo de adopción.** Que el transportista no perciba utilidad y no
...
**Forma de implementación y cronograma.** Se articula en la Capa 1 (Borde Terrestre:
...
**Resultados esperados e indicadores.** Los indicadores parten de una línea base medida:
...
**Alcance y delimitación frente a las bases.** El Capítulo 11 resuelve quién compra el
...
**Forma de implementación y cronograma.** La ventana se aplica en la unidad
...
**Resultados esperados e indicadores.** Línea base cero de ciento cuarenta y ocho transportistas
